			...
			<View style={styles.mainView}>
				...
				<ScrollView style={styles.container}>
					...
					<View style={styles.ul}>
						...
						<Text style={bulletText}>To facilitate our Service</Text>
					</View>
					<View style={styles.ul}>
						<Icon name={'dot-single'} color={'#000'} size={15} />
						<Text style={bulletText}>To provide the Service on our behalf;</Text>
					</View>
					<View style={styles.ul}>
						<Icon name={'dot-single'} color={'#000'} size={15} />
						<Text style={bulletText}>To perform Service-related services</Text>
					</View>
					<View style={styles.ul}>
						<Icon name={'dot-single'} color={'#000'} size={15} />
						<Text style={bulletText}>To assist us in analyzing how our Service is used.</Text>
					</View>
					<Text style={styles.paragraph}>
					...
					<Text style={styles.paragraph}>
						...
						[privacypolicytemplate.net](https://privacypolicytemplate.net) and modified/generated by [App
